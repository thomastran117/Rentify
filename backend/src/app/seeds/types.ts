...
export interface SeedUserFixture {
   ...
   * `createOAuthUser` writes. Such a fixture must also own an entry in
   * `SEED_OAUTH_IDENTITIES`, otherwise it has no way to sign in at all.
   */
  ...
  /**
   * Marks the username as one the OAuth signup flow assigned automatically
